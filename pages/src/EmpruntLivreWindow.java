...
public class EmpruntLivreWindow extends JFrame {
    ...
    private void loadAdherentsCombo() {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bibliotheque-java-djoman-david", "root", "root");
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (disponibilite > 0) {
                    ...
                    JOptionPane.showMessageDialog(this, "<html><font color='green'>Livre emprunté avec succès.</font></html> : " + dateRetour.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
                } else {
